...
kicker = LINE("","wirot2532")
kicker.log("Auth Token : " + str(kicker.authToken))
kicker.log("Timeline Token : " + str(kicker.tl.channelAccessToken))

kicker2 = LINE("","wirot2532")
kicker2.log("Auth Token : " + str(kicker2.authToken))
kicker2.log("Timeline Token : " + str(kicker2.tl.channelAccessToken))

kicker3 = LINE("","wirot2532")
kicker3.log("Auth Token : " + str(kicker3.authToken))
kicker3.log("Timeline Token : " + str(kicker3.tl.channelAccessToken))

kicker4 = LINE("","wirot2532")
kicker4.log("Auth Token : " + str(kicker4.authToken))
kicker4.log("Timeline Token : " + str(kicker4.tl.channelAccessToken))

kicker5 = LINE("","wirot2532")
kicker5.log("Auth Token : " + str(kicker5.authToken))
kicker5.log("Timeline Token : " + str(kicker5.tl.channelAccessToken))

kicker6 = LINE("","wirot2532")
kicker6.log("Auth Token : " + str(kicker6.authToken))
kicker6.log("Timeline Token : " + str(kicker6.tl.channelAccessToken))

kicker7 = LINE("","wirot2532")
kicker7.log("Auth Token : " + str(kicker7.authToken))
kicker7.log("Timeline Token : " + str(kicker7.tl.channelAccessToken))

kicker8 = LINE("","wirot2532")
kicker8.log("Auth Token : " + str(kicker8.authToken))
kicker8.log("Timeline Token : " + str(kicker8.tl.channelAccessToken))

kicker9 = LINE("","wirot2532")
kicker9.log("Auth Token : " + str(kicker9.authToken))
kicker9.log("Timeline Token : " + str(kicker9.tl.channelAccessToken))

kicker10 = LINE("","wirot2532")
kicker10.log("Auth Token : " + str(kicker10.authToken))
kicker10.log("Timeline Token : " + str(kicker10.tl.channelAccessToken))

g1 = LINE("","wirot2532")
g1.log("Auth Token : " + str(g1.authToken))
g1.log("Timeline Token : " + str(g1.tl.channelAccessToken))
